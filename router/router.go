...
func InitRouter(r *gin.Engine) {
	...
	apiRouter := r.Group("/api")
	{
		...
		photoRouter := apiRouter.Group("/photos")
		{
			...
			photoRouter.GET("/:id/attempts/user", ctr.Photo.PhotoAttemptsUser) //获取该用户在某图片下的答题列表
